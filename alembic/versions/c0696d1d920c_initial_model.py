...
Revision ID: c0696d1d920c
Revises:
Create Date: 2025-05-15 15:18:18.525322
...
def upgrade() -> None:
    ...
    # ### Manually added start in order to enable postgis extension ###
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("name", name=op.f("uq_geometries_name")),
    )
    op.create_table(
        "licenses",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("api_authentication_url", sa.String(), nullable=True),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["geometry_id"],
            ["geometries.id"],
            name=op.f("fk_spatial_extent_geometry_relation_geometry_id_geometries"),
        ),
        sa.ForeignKeyConstraint(
            ["spatial_extent_id"],
            ["spatial_extents.id"],
            name=op.f(
                "fk_spatial_extent_geometry_relation_spatial_extent_id_spatial_extents"
            ),
        ),
        sa.PrimaryKeyConstraint(
            "spatial_extent_id",
            "geometry_id",
            name=op.f("pk_spatial_extent_geometry_relation"),
        ),
    )
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table("spatial_extent_geometry_relation")
    op.drop_table("code")
