...
def upgrade() -> None:
    ...
    op.create_index('unique_resource_title_type', 'resources', ['title', 'type'], unique=True)
    ...
    sa.PrimaryKeyConstraint('resource_id', 'category_id', name=op.f('pk_resource_category'))
    )
