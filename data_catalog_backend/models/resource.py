...
class Resource(Base):
    ...
    used_by: Mapped[List["Resource"]] = relationship("Resource", secondary="resource_resource", primaryjoin=resource_id == ResourceResource.c.based_on, secondaryjoin=resource_id == ResourceResource.c.used_by, back_populates="based_on")
    based_on: Mapped[List["Resource"]] = relationship("Resource", secondary="resource_resource", primaryjoin=resource_id == ResourceResource.c.used_by, secondaryjoin=resource_id == ResourceResource.c.based_on, back_populates="used_by")
